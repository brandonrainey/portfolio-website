...
export default function AboutMe(props) {
  ...
  return (
    <div
      ref={aboutMeDiv}
      className={`flex justify-center mt-40 flex-col text-center bg-gradient-to-t from-[#13385c]/50 to-[#01101f43]  md:w-3/4 py-8 self-center rounded-lg drop-shadow-lg ${
